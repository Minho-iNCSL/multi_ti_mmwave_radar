...
def generate_launch_description():
    ...
    static_transform_publisher = Node(
        ...
        arguments = "0 -2 0 0 0 0 ti_mmwave_pcl ti_mmwave_right".split()
    )

    """Generate launch description with multiple components."""
    container = ComposableNodeContainer(
            node_name='mmwave_right_container',
            node_namespace='',
            ...
            composable_node_descriptions=[
                ComposableNode(
                    ...
                    parameters=[{
                        "data_port": "/dev/ttyUSB5",
                        "data_rate": 921600,
                        "frame_id": "ti_mmwave_right",
